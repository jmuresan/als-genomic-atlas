...
def generate_report(db_path: str, output_path: str):
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        f.write("A reference compilation of molecular and genomic data for genes associated with Amyotrophic Lateral Sclerosis (ALS), generated from a DuckDB database and organized into 11 data categories.\n\n")
